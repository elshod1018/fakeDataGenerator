...
import static com.company.FakeDataApplicationService.BLACK_LIST;
...
public class FakeDataApplicationRunner {
    ...
    public static void main(String[] args) {
        var fakerDataGeneratorService = new FakeDataApplicationService();
     ...
     * {@link  com.company.FileType#JSON};
     */
